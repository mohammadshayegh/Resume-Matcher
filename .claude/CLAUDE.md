...
│   │   ├── models.py        # SQLAlchemy ORM models (Resume/Job/Improvement/Application/ApiKey/JobSearchPreference/JobSearchListing)
...
| **Job search (JobSpy)** | [job-search.md](../docs/agent/features/job-search.md) — board scraping, strict option values, 4-hour cooldown, deduped 14-day result cache |
