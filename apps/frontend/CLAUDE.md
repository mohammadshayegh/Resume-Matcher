...
| `/settings`                | `app/(default)/settings/page.tsx`      | Client                                                   | AI backend **read-only** (active provider/model, health, consumption + remaining quota, connection probe), features, prompts, language, reset DB |
