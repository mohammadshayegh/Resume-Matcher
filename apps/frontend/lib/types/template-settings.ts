...
export const buildHeaderFontMap = (): Record<HeaderFontFamily, string> => ({
  serif: 'ui-serif, Georgia, Cambria, "Times New Roman", Times, serif',
  'sans-serif': 'ui-sans-serif, system-ui, sans-serif, "Apple Color Emoji", "Segoe UI Emoji"',
  mono: 'ui-monospace, SFMono-Regular, "SF Mono", Menlo, Consolas, monospace',
});

export const buildBodyFontMap = (): Record<BodyFontFamily, string> => buildHeaderFontMap();
...
export function settingsToCssVars(settings?: TemplateSettings): React.CSSProperties {
  ...
  return {
    ...
    '--header-font': buildHeaderFontMap()[s.fontSize.headerFont],
    '--body-font': buildBodyFontMap()[s.fontSize.bodyFont],
